...
The mean score for the post treatment measure "What do you think about the way the decision was made?" is `r mean(d$fairness)`, and the standard deviation is `r sd(d$fairness)`.
...
The mean score for the post treatment measure "How just do you think the decision procedure was?" is `r mean(d$justice)`, and the standard deviation is `r sd(d$justice)`.
...
```
The mean score for the post treatment measure "What do you think in general about the decision?" is `r mean(d$eval)`, and the standard deviation is `r sd(d$eval)`.
...
The mean score for the post treatment measure "How willing are you to accept and comply with the decision?" is `r mean(d$comply)`, and the standard deviation is `r sd(d$comply)`.
