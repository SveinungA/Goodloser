...
In the manuscript, we mention that the generic good loser prime for the respondents with an unfavorable outcome is on par with the outcome favorability effect (difference in fairness perceptions between winners and losers). The table below displays the outcome favorability effect, and table 'tab:1055_post_fairness' further below displays the treatment effect of the generic good loser prime,
```{r 1050_int_outfav}
