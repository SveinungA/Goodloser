...
```{r 104_post_fairness_favorability}
...
fig <-   res_main %>%
  ...
  labs(x = "Change in fairness perceptions",
       y = "",
       title = 'Fairness perceptions moderated by outcome favorability, Study 1 -- Swedish vignette',
       caption = 'Reference category: Respondents with favorable outcome.') +
  theme_bw() +
...
kable(table, booktabs = TRUE, caption = "Fairness perceptions moderated by outcome favorability, Study 1 -- Swedish vignette", col.names = linebreak(c("Treatment value", "Estimate", "Std. Error", "t-statistic", "p value")), digits = 2) %>% 
