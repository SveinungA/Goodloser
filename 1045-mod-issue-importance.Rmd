...
#for bookdown
kable(table, booktabs = TRUE, caption = "Moderating effects of issue importance on experimental treatment, Study 1 -- Swedish vignette", digits = 2, col.names = linebreak(c("Factor", 'Issue importance', "AME", "SE", "z-statistic", "p value", 'Lower', 'Upper'))) %>% 
...
table <- table %>% 
  ...
  mutate(term = case_when( term == "(Intercept)" ~ "Intercept",
                    ...
                    term == "treatmentGeneral prime:opinion_strengthNot important" ~ "Generic good loser prime w/ issue not important to respondent")
         ) 
