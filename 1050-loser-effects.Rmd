...
fig <- summary(margins(res, at = list(favorability = c('Favorable', 'Unfavorable')))) %>% 
  ...
  labs(x = 'Average marginal treatment effect',
       ...
       title = "Conditional effect of outcome favorability on general prime treatment, Study 1.",
...
#for bookdown
kable(table, booktabs = TRUE, caption = "Conditional effect of outcome favorability on general prime treatment, Study 1 -- Swedish vignette", col.names = linebreak(c("Treatment value", "Estimate", "Std. Error", "t-statistic", "p value")), digits = 2) %>% 
