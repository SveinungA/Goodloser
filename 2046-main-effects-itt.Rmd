# Main effects with full ITT sample

```{r 2046_packages, include=FALSE}
...
fig <-   res_main %>%
  ...
  labs(x = "Change in fairness perceptions",
       ...
       subtitle = 'Sample: Full ITT sample.') +
  theme_bw() +
...
ggsave(
  here("output", "novig", "figs", "pngs", "exp2-fairness-mainfig-itt.png"),
  plot = fig,
  width = 5.5, height = 2.75
)

ggsave(
  here("output", "novig", "figs", "pdfs", "exp2-fairness-mainfig-itt.pdf"),
  plot = fig,
  width = 5.5, height = 2.75
)
...
kable(table, booktabs = TRUE, caption = "Treatment effects on fairness perceptions of decision, Study 2 -- Norwegian vignette. 'Sample: Full ITT sample.'", col.names = linebreak(c("Treatment value", "Estimate", "Std. Error", "t-statistic", "p value")), digits = 2)

kable(table, booktabs = TRUE, caption = "Treatment effects on fairness perceptions of decision, Study 2 -- Norwegian vignette. Sample: Full ITT sample.", col.names = linebreak(c("Treatment value", "Estimate", "Std. Error", "t-statistic", "p value")), digits = 2) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "responsive")) %>% 
  cat(., file = here("output", "novig", "tbls", "html",  "tbl-fairness-novig-itt.html"))
```
...
ggsave(
  here("output", "novig", "figs", "pngs", "exp2-accept-mainfig-itt.png"),
  plot = fig,
  width = 7, height = 2.75
)

ggsave(
  here("output", "novig", "figs", "pdfs", "exp2-accept-mainfig-itt.pdf"),
  plot = fig,
  width = 7, height = 2.75
)
...
kable(table, booktabs = TRUE, caption = "Treatment effects on willingness to accept decision, Study 2 -- Norwegian vignette. Sample: Full ITT sample.", col.names = linebreak(c("Treatment value", "Estimate", "Std. Error", "t-statistic", "p value")), digits = 2)

kable(table, booktabs = TRUE, caption = "Treatment effects on willingness to accept decision, Study 2 -- Norwegian vignette. Sample: Full ITT sample.", col.names = linebreak(c("Treatment value", "Estimate", "Std. Error", "t-statistic", "p value")), digits = 2) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "responsive"))  %>% 
  cat(., file = here("output", "novig", "tbls", "html",  "tbl-accept-novig-itt.html"))
```
...
ggsave(
  here("output", "novig", "figs", "pngs", "exp2-trust-mainfig-itt.png"),
  plot = fig,
  width = 5.5, height = 2.75
)

ggsave(
  here("output", "novig", "figs", "pdfs", "exp2-trust-mainfig-itt.pdf"),
  plot = fig,
  width = 5.5, height = 2.75
)
...
kable(table, booktabs = TRUE, caption = "Treatment effects on trust in politician, Study 2 -- Norwegian vignette. Sample: Full ITT sample.", col.names = linebreak(c("Treatment value", "Estimate", "Std. Error", "t-statistic", "p value")), digits = 2) 

kable(table, booktabs = TRUE, caption = "Treatment effects on trust in politician, Study 2 -- Norwegian vignette. Sample: Full ITT sample.", col.names = linebreak(c("Treatment value", "Estimate", "Std. Error", "t-statistic", "p value")), digits = 2) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "responsive"))  %>% 
  cat(., file = here("output", "novig", "tbls", "html",  "tbl-trust-novig-itt.html"))
```
