...
>Main effects with sample of respondents who receive an unfavorable outcome. 
...
fig <-   res_main %>%
  ...
  labs(x = "Change in fairness perception",
       y = "",
      title = 'Treatment effects on fairness perceptions, Study 2 -- Norwegian vignette.', 
...
kable(table, booktabs = TRUE, caption = "Treatment effects among losers on fairness perceptions of decision, Study 2 -- Norwegian vignette", col.names = linebreak(c("Treatment value", "Estimate", "Std. Error", "t-statistic", "p value")), digits = 2) %>% 
...
```{r 2050_importance_treatment_fairness}
res <-  lm(fairness ~ factor(treatment)*opinion_strength, data = d) 

fig <- summary(margins(res, at = list(opinion_strength = 1:5)))  %>% 
...
#for bookdown
kable(table, booktabs = TRUE, caption = "Moderating effects of issue importance on experimental treatment, Study 2 -- Norwegian vignette", digits = 2, col.names = linebreak(c("Factor", 'Issue importance', "AME", "SE", "z-statistic", "p value", 'Lower', 'Upper'))) %>% 
...
```{r 2050_norm_treatment_fairness}
res <-  lm(fairness ~ factor(treatment)*imp_accept, data = d) 

fig <- summary(margins(res, at = list(imp_accept = 1:5)))  %>% 
  filter(factor == 'treatmentGeneral Prime') %>% 
  ...
  labs(x = 'Average marginal treatment effect',
       ...
       title = "Conditional effect of good loser norm on general prime treatment.",
       subtitle = 'Outcome measure: Fairness perception of decision. Sample: Respondents with unfavorable outcome.') +
  theme_bw() +
  theme(plot.title = element_text(size=9), plot.subtitle = element_text(size=8), plot.margin = unit(c(2, 2, 2, 2), "mm"), axis.text.x=element_text(size=rel(0.7))) +
  theme(panel.spacing = unit(0.5, "lines"))
...
#for bookdown
kable(table, booktabs = TRUE, caption = "Moderating effects of norm importance on experimental treatment, Study 2 -- Norwegian vignette", digits = 2, col.names = linebreak(c("Factor", 'Norm importance', "AME", "SE", "z-statistic", "p value", 'Lower', 'Upper'))) %>% 
  kable_styling(latex_options = "HOLD_position")   %>% 
  footnote(general = 'Sample: Respondents with unfavorable outcome.')
#save to file
kable(table, booktabs = TRUE, caption = "Moderating effects of norm importance on experimental treatment, Study 2 -- Norwegian vignette", digits = 2, col.names = linebreak(c("Factor", 'Norm importance', "AME", "SE", "z-statistic", "p value", 'Lower', 'Upper'))) %>% 
...
kable(table, booktabs = TRUE, caption = "Treatment effects among losers on willingness to accept decision, Study 2 -- Norwegian vignette", col.names = linebreak(c("Treatment value", "Estimate", "Std. Error", "t-statistic", "p value")), digits = 2) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "responsive"))  
...
kable(table, booktabs = TRUE, caption = "Treatment effects among losers on trust in politician, Study 2 -- Norwegian vignette", col.names = linebreak(c("Treatment value", "Estimate", "Std. Error", "t-statistic", "p value")), digits = 2) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "responsive")) 
