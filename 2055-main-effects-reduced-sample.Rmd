## Main effects with reduced sample {#reduced-sample}
...
fig <-   res_main %>%
  ...
  labs(x = "Change in fairness perceptions",
       y = "",
       title = 'Treatment effects on fairness perceptions of decision, Study 2.',
...
kable(table, booktabs = TRUE, caption = "Treatment effects on trust in politician, Study 2. Sample: Respondents who pass manipulation check.", col.names = linebreak(c("Treatment value", "Estimate", "Std. Error", "t-statistic", "p value")), digits = 2) 
