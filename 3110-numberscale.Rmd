# Numbered answer scale
```{r 311_setup, include=FALSE}
...
main_01 <- main_01 %>%   
      filter(scale == "Numbered")
 
``` 


## Reasonable decision
```{r 311_post_reasonable_numberscale}
...
fig_amce <-
  ...
  scale_x_continuous(
   ...
   y = "",
    ...
    subtitle = 'Sample: Respondents who received a numbered answer scale') +
  theme_bw() +
...
ggsave(
  here("output", "nocon", "figs", "pngs", "fig_numberscale_reasonable.png"),
  plot = fig_amce,
  width = 6, height = 2.75
)

ggsave(
  here("output", "nocon", "figs", "pdfs", "fig_numberscale_reasonable.pdf"),
  plot = fig_amce,
  width = 6, height = 2.75
)
...
kable(res_main, booktabs = TRUE, caption = "Average Marginal Component Effect -- Norwegian conjoint experiment", col.names = linebreak(c("Treatment value", "Estimate", "Std. Error", "t-statistic", "p value")), digits = 2) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "responsive")) %>% 
 group_rows(index = c("Winning margin" = 3, "Winner gloating" = 2, "Good loser prime" = 4, "Messenger" = 2))%>% 
  cat(., file = here("output", "nocon", "tbls", "html",  "tbl-numberscale-reasonable-nocon.html"))
```
       
## Willingnes to accept
```{r 311_post_accept_numberscale}
...
ggsave(
  here("output", "nocon", "figs", "pngs", "fig_numberscale_accept.png"),
  plot = fig_amce,
  width = 6, height = 2.75
)

ggsave(
  here("output", "nocon", "figs", "pdfs", "fig_numberscale_accept.pdf"),
  plot = fig_amce,
  width = 6, height = 2.75
)
...
kable(res_main, booktabs = TRUE, caption = "Average Marginal Component Effects -- Norwegian conjoint experiment", col.names = linebreak(c("Treatment value", "Estimate", "Std. Error", "t-statistic", "p value")), digits = 2) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "responsive")) %>% 
 group_rows(index = c("Winning margin" = 3, "Winner gloating" = 2, "Good loser prime" = 4, "Messenger" = 2))%>% 
  cat(., file = here("output", "nocon", "tbls", "html",  "tbl-numberscale-accept-nocon.html"))

```

## Fairness perceptions
```{r 311_post_fair_numberscale}
...
ggsave(
  here("output", "nocon", "figs", "pngs", "fig_numberscale_fair.png"),
  plot = fig_amce,
  width = 5.5, height = 2.75
)

ggsave(
  here("output", "nocon", "figs", "pdfs", "fig_numberscale_fair.pdf"),
  plot = fig_amce,
  width = 5.5, height = 2.75
)
...
kable(res_main, booktabs = TRUE, caption = "Average Marginal Component Effects -- Norwegian conjoint experiment", col.names = linebreak(c("Treatment value", "Estimate", "Std. Error", "t-statistic", "p value")), digits = 2) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "responsive")) %>% 
 group_rows(index = c("Winning margin" = 3, "Winner gloating" = 2, "Good loser prime" = 4, "Messenger" = 2))%>% 
  cat(., file = here("output", "nocon", "tbls", "html",  "tbl-numberscale-fairness-nocon.html"))
